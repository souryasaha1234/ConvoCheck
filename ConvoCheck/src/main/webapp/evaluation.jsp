...
<html lang="en">
    <head>
        ...
        <title>ConvoCheck | Evaluation</title>
        <!-- CSS only -->
        <link
            rel="stylesheet"
	...
	%>
        ...
        <div class="the_form">
            <form action="EquationEvaluationServlet" method="post">
                <label for="from_base">Choose the Evaluation:</label>
                <select id="from_base" class="form-control" name="evaluation" value="${evaluation }">
                    <option value="prefixEvaluation">Prefix Evaluation</option>
                    <option value="postfixEvaluation">
                        Postfix Evaluation
                    </option>
                </select>

                <label for="num"
                    >Enter a valid space separated Expression:
                </label>
                <input
                    type="text"
                    id="num"

...
<head>
    ...
    <title>ConvoCheck | Equation Conversion</title>
    <!-- CSS only -->
...
<body>
  ...
  //Controlling the Back Button after Log_out
            ...
            <li>
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                      <a href="equationConversion" id="this_nav">Equation Conversion</a>
    ...
    <div class="the_form">
        <form action="EquationConversionServlet" method="post">
            ...
            <input type="text" id="num" name="input_number" value="${expression }" placeholder="eg@123" required>
